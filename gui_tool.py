...
#     meter.create_text(width // 2, 10, text=f"{score}/4", fill="white", font=("Segoe UI", 10, "bold"))
...
# print("Launching GUI...")
# root = tk.Tk()
# root.title("Hafiz Cyber-Crypto Tool Pro")
...
# icon = tk.Label(top, text="🔐", font=("Segoe UI Emoji", 22), bg="#020617", fg="#60a5fa")
# icon.pack(side="left", padx=(0, 12))

# title_block = ttk.Frame(top, style="Dark.TFrame")
# title_block.pack(side="left", fill="x", expand=True)

# title_label = tk.Label(title_block, text="Hafiz Cyber-Crypto Tool Pro", font=("Segoe UI", 22, "bold"), bg="#020617", fg="#e2e8f0")
# title_label.pack(anchor="w")
# subtitle_label = tk.Label(title_block, text="Modern password encryption dashboard with live analysis", font=("Segoe UI", 10), bg="#020617", fg="#94a3b8")
...
# pwd_label = tk.Label(card, text="Enter Password", font=("Segoe UI", 11, "bold"), bg="#0f172a", fg="#e2e8f0")
# pwd_label.pack(anchor="w")

# entry_pwd = ttk.Entry(card, show="*", font=("Segoe UI", 12))
# entry_pwd.pack(fill="x", pady=(8, 12))

# meter_label = tk.Label(card, text="Strength Meter", font=("Segoe UI", 10, "bold"), bg="#0f172a", fg="#cbd5e1")
...
# info_label = tk.Label(card, text="Tip: Use 8+ characters, uppercase letters, digits, and special symbols.", font=("Segoe UI", 9), bg="#0f172a", fg="#cbd5e1")
# info_label.pack(anchor="w", pady=(0, 8))

# status_var = tk.StringVar(value="Ready. Enter a password to begin.")
# status_label = tk.Label(card, textvariable=status_var, font=("Segoe UI", 10, "italic"), bg="#0f172a", fg="#cbd5e1")
# status_label.pack(anchor="w", pady=(0, 8))

# result_box = scrolledtext.ScrolledText(card, height=18, wrap=tk.WORD, font=("Consolas", 11), bg="#020617", fg="#e2e8f0", insertbackground="white", relief="flat")
# result_box.pack(fill="both", expand=True)
# result_box.insert(tk.END, "Enter a password, then click Encrypt & Save.\n")

# footer = ttk.Frame(main, style="Dark.TFrame")
# footer.pack(fill="x", pady=(10, 0))
# footer_label = tk.Label(footer, text="Project mode: GUI + encryption + local save", font=("Segoe UI", 9), bg="#020617", fg="#64748b")
...
try:
    ...
    try:
        icon_img = tk.PhotoImage(file="ghost.png")
